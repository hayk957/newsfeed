    ...
    <div class="col-md-9 right">
        <div class="container">
            <form method="get">
                ...
                <div class="col-md-4">
                    <button type="submit" name="yes" class="form-control logout_bt_margin input-md red_button">Yes
                    </button>
                </div>
                <div class="col-md-4">
                    <button type="submit" name="no" class="form-control logout_bt_margin input-md green_button">No
                    </button>
                </div>
                <?php
